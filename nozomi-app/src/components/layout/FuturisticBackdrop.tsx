...
/** Global ambient layer: speed lines, vignette, signal particles */
export function FuturisticBackdrop() {
  return (
    <div className="futuristic-backdrop pointer-events-none fixed inset-0 z-0" aria-hidden>
      ...
      <div className="signal-speedlines" />
      <div className="signal-slash signal-slash--a" />
      <div className="signal-slash signal-slash--b" />
