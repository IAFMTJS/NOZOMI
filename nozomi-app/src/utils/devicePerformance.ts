...
export function getVoicePlatformTuning(): VoicePlatformTuning {
  ...
  return {
    ...
    whisperChunkSec: legacy ? 4 : pro ? 6 : 5,
    whisperStrideSec: legacy ? 1 : pro ? 2 : 1,
    whisperLongChunkSec: legacy ? 8 : pro ? 10 : 8,
    whisperLongStrideSec: legacy ? 2 : pro ? 3 : 2,
    maxDecodeSamples16k: (legacy ? 10 : pro ? 14 : 12) * 16_000,
